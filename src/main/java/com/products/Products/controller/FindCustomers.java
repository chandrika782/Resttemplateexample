...
import com.products.Products.model.Employee;
...
public class FindCustomers {
	...
	@GetMapping("/customer")
	public Employee[] getCustomerDetails() {
		
		
		
		RestTemplate restTemplate=new RestTemplate();
		Employee[] output = restTemplate.getForObject("http://localhost:9081/employee/getDetails", Employee[].class);
